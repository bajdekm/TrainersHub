...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"0244c826-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/pug-plain-loader!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/vue-cal/index.vue?vue&type=template&id=0fe47911&lang=pug&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"vuecal__flex vuecal",class:_vm.cssClasses,attrs:{"column":"","lang":_vm.locale}},[_c('vuecal-header',{attrs:{"vuecal-props":_vm.$props,"view-props":{ views: _vm.views, view: _vm.view, hasSplits: _vm.hasSplits },"months":_vm.months,"week-days":_vm.weekDays,"week-days-short":_vm.weekDaysShort}},[_vm._t("arrowPrev",[_c('i',{staticClass:"angle"})],{"slot":"arrowPrev"}),_vm._t("arrowNext",[_c('i',{staticClass:"angle"})],{"slot":"arrowNext"}),_vm._t("title",[_vm._v(_vm._s(_vm.viewTitle))],{"slot":"title","title":_vm.viewTitle,"view":_vm.view})],2),(!_vm.hideBody)?_c('div',{staticClass:"vuecal__flex vuecal__body",attrs:{"grow":""}},[_c('transition',{attrs:{"name":("slide-fade--" + _vm.transitionDirection),"appear":_vm.transitions}},[_c('div',{key:_vm.transitions ? _vm.view.id : false,staticClass:"vuecal__flex",staticStyle:{"min-width":"100%"},attrs:{"column":""}},[(_vm.showAllDayEvents && _vm.hasTimeColumn)?_c('div',{staticClass:"vuecal__flex vuecal__all-day"},[_c('span',{staticStyle:{"width":"3em"}},[_c('span',[_vm._v(_vm._s(_vm.texts.allDay))])]),_c('div',{staticClass:"vuecal__flex vuecal__cells",class:((_vm.view.id) + "-view"),attrs:{"grow":"","wrap":!_vm.hasSplits || _vm.view.id !== 'week',"column":_vm.hasSplits}},_vm._l((_vm.viewCells),function(cell,i){return _c('vuecal-cell',{key:i,class:cell.class,attrs:{"date":cell.date,"formatted-date":cell.formattedDate,"all-day-events":true,"today":cell.today,"splits":_vm.hasSplits && _vm.splitDays || []},nativeOn:{"click":function($event){return _vm.selectCell(cell)},"dblclick":function($event){_vm.dblClickToNavigate && _vm.switchToNarrowerView()}},scopedSlots:_vm._u([{key:"event-renderer",fn:function(ref){
var event = ref.event;
var view = ref.view;
return _c('div',{attrs:{"view":view,"event":event}},[_vm._t("event-renderer",[(_vm.editableEvents && event.title)?_c('div',{staticClass:"vuecal__event-title vuecal__event-title--edit",attrs:{"contenteditable":""},domProps:{"innerHTML":_vm._s(event.title)},on:{"blur":function($event){return _vm.onEventTitleBlur($event, event)}}}):(event.title)?_c('div',{staticClass:"vuecal__event-title",domProps:{"innerHTML":_vm._s(event.title)}}):_vm._e(),(event.content && _vm.showAllDayEvents !== 'short' && !_vm.isShortMonthView)?_c('div',{staticClass:"vuecal__event-content",domProps:{"innerHTML":_vm._s(event.content)}}):_vm._e()],{"view":view,"event":event})],2)}}],null,true)},[_vm._t("no-event",null,{"slot":"no-event"})],2)}),1)]):_vm._e(),_c('div',{staticClass:"vuecal__bg",class:{ vuecal__flex: !_vm.hasTimeColumn },attrs:{"column":""}},[_c('div',{staticClass:"vuecal__flex",attrs:{"row":"","grow":""}},[(_vm.hasTimeColumn)?_c('div',{staticClass:"vuecal__time-column"},_vm._l((_vm.timeCells),function(cell,i){return _c('div',{key:i,staticClass:"vuecal__time-cell",style:(("height: " + _vm.timeCellHeight + "px"))},[_vm._t("time-cell",[_c('span',{staticClass:"line"},[_vm._v(_vm._s(cell.label))])],{"hours":cell.hours,"minutes":cell.minutes})],2)}),0):_vm._e(),_c('div',{staticClass:"vuecal__flex vuecal__cells",class:((_vm.view.id) + "-view"),attrs:{"grow":"","wrap":!_vm.hasSplits || _vm.view.id !== 'week',"column":_vm.hasSplits}},[(_vm.hasSplits && _vm.view.id === 'week')?_c('weekdays-headings',{attrs:{"transitions":{ active: _vm.transitions, direction: _vm.transitionDirection },"view":_vm.view,"min-cell-width":_vm.minCellWidth,"week-days":_vm.weekDays,"week-days-short":_vm.weekDaysShort}}):_vm._e(),_c('div',{staticClass:"vuecal__flex",attrs:{"grow":"","wrap":!_vm.hasSplits || _vm.view.id !== 'week'}},_vm._l((_vm.viewCells),function(cell,i){return _c('vuecal-cell',{key:i,class:cell.class,attrs:{"date":cell.date,"formatted-date":cell.formattedDate,"today":cell.today,"content":cell.content,"splits":_vm.hasSplits && _vm.splitDays || []},nativeOn:{"click":function($event){return _vm.selectCell(cell)},"dblclick":function($event){_vm.dblClickToNavigate && _vm.switchToNarrowerView()}},scopedSlots:_vm._u([{key:"events-count-month-view",fn:function(ref){
var events = ref.events;
return _c('div',{staticClass:"vuecal__cell-events-count",attrs:{"events":events}},[_vm._t("events-count-month-view",[(events.length)?_c('span',[_vm._v(_vm._s(events.length))]):_vm._e()],{"events":events})],2)}},{key:"event-renderer",fn:function(ref){
var event = ref.event;
var view = ref.view;
return _c('div',{attrs:{"view":view,"event":event}},[_vm._t("event-renderer",[(_vm.editableEvents && event.title)?_c('div',{staticClass:"vuecal__event-title vuecal__event-title--edit",attrs:{"contenteditable":""},domProps:{"innerHTML":_vm._s(event.title)},on:{"blur":function($event){return _vm.onEventTitleBlur($event, event)}}}):(event.title)?_c('div',{staticClass:"vuecal__event-title",domProps:{"innerHTML":_vm._s(event.title)}}):_vm._e(),(event.startTimeMinutes && !(view === 'month' && event.allDay && _vm.showAllDayEvents === 'short') && !_vm.isShortMonthView)?_c('div',{staticClass:"vuecal__event-time"},[_vm._v(_vm._s(_vm._f("formatTime")(event.startTimeMinutes,_vm.timeFormat || (_vm.$props['12Hour'] ? 'h:mm{am}' : 'HH:mm')))),(event.endTimeMinutes)?_c('span',[_vm._v(" - "+_vm._s(_vm._f("formatTime")(event.endTimeMinutes,_vm.timeFormat || (_vm.$props['12Hour'] ? 'h:mm{am}' : 'HH:mm'))))]):_vm._e(),(event.multipleDays.daysCount)?_c('small',{staticClass:"days-to-end"},[_vm._v(" +"+_vm._s(event.multipleDays.daysCount - 1)+_vm._s((_vm.texts.day[0] || '').toLowerCase()))]):_vm._e()]):_vm._e(),(event.content && !(view === 'month' && event.allDay && _vm.showAllDayEvents === 'short') && !_vm.isShortMonthView)?_c('div',{staticClass:"vuecal__event-content",domProps:{"innerHTML":_vm._s(event.content)}}):_vm._e()],{"view":view,"event":event})],2)}}],null,true)},[_vm._t("no-event",[_vm._v(_vm._s(_vm.texts.noEvent))],{"slot":"no-event"})],2)}),1)],1)])])])])],1):_vm._e()],1)}
var staticRenderFns = []


// CONCATENATED MODULE: ./src/components/vue-cal/index.vue?vue&type=template&id=0fe47911&lang=pug&
  ...
  if (event.multipleDays.daysCount) {
    event.linked.forEach(function (e) {
      ...
      if (!e.background) {
        ...
        event_utils_deleteLinkedEvents(eventToDelete, dayToModify);
      }
    });
...
var onResizeEvent = function onResizeEvent(cellEvents, vuecal) {
  ...
  if (event) {
    ...
    event_utils_updateEndTimeOnResize(event, vuecal);
    if (!event.background) event_utils_checkCellOverlappingEvents(cellEvents);
  }
};

var event_utils_updateEndTimeOnResize = function updateEndTimeOnResize(event, vuecal) {
    ...
    if (foregroundEventsList.length) {
      ...
      cellEvents.forEach(function (event) {
        if (!event.background) {
          ...
          comparisonArray[event.eid] = cellEvents.length ? foregroundEventsList.filter(function (item) {
            return item.eid !== event.eid && !comparisonArrayKeys.includes(item.eid);
          }).map(function (item) {
            return item.eid;
          }) : foregroundEventsIdList.filter(function (id) {
            return id !== event.eid && !comparisonArrayKeys.includes(id);
          });

          if (comparisonArray[event.eid].length) {
            event_utils_checkOverlappingEvents(event, comparisonArray[event.eid], cellEvents);
          }
        }
      });
    }
...
var event_utils_checkOverlappingEvents = function checkOverlappingEvents(event, comparisonArray, cellEvents) {
  ...
  comparisonArray.forEach(function (event2id) {
    ...
    if (event1overlapsEvent2) {
      external_commonjs_vue_commonjs2_vue_root_Vue_default.a.set(event.overlapping, event2.eid, true);
      external_commonjs_vue_commonjs2_vue_root_Vue_default.a.set(event2.overlapped, event.eid, true);
    } else {
    ...
    if (event2overlapsEvent1) {
      external_commonjs_vue_commonjs2_vue_root_Vue_default.a.set(event2.overlapping, event.eid, true);
      external_commonjs_vue_commonjs2_vue_root_Vue_default.a.set(event.overlapped, event2.eid, true);
    } else {
    ...
    if (startTimeMinE1 === startTimeMinE2 || event1overlapsEvent2 || event2overlapsEvent1) {
      external_commonjs_vue_commonjs2_vue_root_Vue_default.a.set(event.simultaneous, event2.eid, true);
      external_commonjs_vue_commonjs2_vue_root_Vue_default.a.set(event2.simultaneous, event.eid, true);
    } else {
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"0244c826-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/pug-plain-loader!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/vue-cal/header.vue?vue&type=template&id=eee908fc&lang=pug&
var headervue_type_template_id_eee908fc_lang_pug_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"vuecal__header"},[(!_vm.vuecalProps.hideViewSelector)?_c('ul',{staticClass:"vuecal__flex vuecal__menu"},_vm._l((_vm.viewProps.views),function(v,id){return (v.enabled)?_c('li',{class:{ active: _vm.viewProps.view.id === id },on:{"click":function($event){return _vm.$parent.switchView(id, null, true)}}},[_vm._v(_vm._s(v.label))]):_vm._e()}),0):_vm._e(),(!_vm.vuecalProps.hideTitleBar)?_c('div',{staticClass:"vuecal__title"},[_c('div',{staticClass:"vuecal__arrow vuecal__arrow--prev",on:{"click":_vm.previous}},[_vm._t("arrowPrev")],2),_c('transition',{attrs:{"name":("slide-fade--" + _vm.transitionDirection)}},[_c('div',{key:_vm.vuecalProps.transitions ? ("" + (_vm.viewProps.view.id) + (_vm.viewProps.view.startDate)) : false,class:{ clickable: !!_vm.broaderView },staticStyle:{"display":"inline-block"},on:{"click":_vm.switchToBroaderView}},[_vm._t("title")],2)]),_c('div',{staticClass:"vuecal__arrow vuecal__arrow--next",on:{"click":_vm.next}},[_vm._t("arrowNext")],2)],1):_vm._e(),(['month', 'week'].indexOf(_vm.viewProps.view.id) > -1 && !(_vm.viewProps.hasSplits && _vm.viewProps.view.id === 'week'))?_c('weekdays-headings',{attrs:{"view":_vm.viewProps.view,"week-days":_vm.weekDays,"week-days-short":_vm.weekDaysShort,"transitions":{ active: _vm.vuecalProps.transitions, direction: _vm.transitionDirection }}}):_vm._e()],1)}
var headervue_type_template_id_eee908fc_lang_pug_staticRenderFns = []


// CONCATENATED MODULE: ./src/components/vue-cal/header.vue?vue&type=template&id=eee908fc&lang=pug&

// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"0244c826-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/pug-plain-loader!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/vue-cal/weekdays-headings.vue?vue&type=template&id=7e8ad2df&lang=pug&
var weekdays_headingsvue_type_template_id_7e8ad2df_lang_pug_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"vuecal__flex vuecal__weekdays-headings"},_vm._l((_vm.headings),function(heading,i){return _c('div',{key:i,staticClass:"vuecal__flex vuecal__heading",class:{ today: heading.today },style:(_vm.weekdayCellStyles)},[_c('transition',{attrs:{"name":("slide-fade--" + (_vm.transitions.direction)),"appear":_vm.transitions.active}},[_c('span',{key:_vm.transitions.active ? (i + "-" + (heading.date)) : false},[_c('span',{staticClass:"full"},[_vm._v(_vm._s(heading.full))]),_c('span',{staticClass:"small"},[_vm._v(_vm._s(heading.small))]),_c('span',{staticClass:"xsmall"},[_vm._v(_vm._s(heading.xsmall))]),(heading.date)?_c('span',[_vm._v(" "+_vm._s(heading.date))]):_vm._e()])])],1)}),0)}
var weekdays_headingsvue_type_template_id_7e8ad2df_lang_pug_staticRenderFns = []


// CONCATENATED MODULE: ./src/components/vue-cal/weekdays-headings.vue?vue&type=template&id=7e8ad2df&lang=pug&
...
/* harmony default export */ var weekdays_headingsvue_type_script_lang_js_ = ({
  ...
  computed: {
    ...
    weekdayCellStyles: function weekdayCellStyles() {
      return {
        minWidth: this.minCellWidth ? "".concat(this.minCellWidth, "px") : null
      };
    }
  }
});
...
var component = normalizeComponent(
  ...
  weekdays_headingsvue_type_template_id_7e8ad2df_lang_pug_render,
  weekdays_headingsvue_type_template_id_7e8ad2df_lang_pug_staticRenderFns,
  false,
  null,
  null,
  null
...
/* harmony default export */ var headervue_type_script_lang_js_ = ({
  ...
  methods: {
    previous: function previous() {
      ...
      switch (this.viewProps.view.id) {
        ...
        case 'year':
          var firstDayOfYear = new Date(this.viewProps.view.startDate.getFullYear() - 1, 1, 1);
          this.$parent.switchView(this.viewProps.view.id, firstDayOfYear);
          break;

        case 'month':
          var firstDayOfMonth = new Date(this.viewProps.view.startDate.getFullYear(), this.viewProps.view.startDate.getMonth() - 1, 1);
          this.$parent.switchView(this.viewProps.view.id, firstDayOfMonth);
          break;

        case 'week':
          var firstDayOfPrevWeek = getPreviousFirstDayOfWeek(this.viewProps.view.startDate, this.vuecalProps.startWeekOnSunday).subtractDays(7);
          this.$parent.switchView(this.viewProps.view.id, firstDayOfPrevWeek);
          break;

        case 'day':
          var day = this.viewProps.view.startDate.subtractDays(1);
    ...
    next: function next() {
      ...
      switch (this.viewProps.view.id) {
        ...
        case 'year':
          var firstDayOfYear = new Date(this.viewProps.view.startDate.getFullYear() + 1, 0, 1);
          this.$parent.switchView(this.viewProps.view.id, firstDayOfYear);
          break;
        ...
        case 'week':
          var firstDayOfNextWeek = getPreviousFirstDayOfWeek(this.viewProps.view.startDate, this.vuecalProps.startWeekOnSunday).addDays(7);
          this.$parent.switchView(this.viewProps.view.id, firstDayOfNextWeek);
          break;

        case 'day':
          var day = this.viewProps.view.startDate.addDays(1);
          this.$parent.switchView(this.viewProps.view.id, day);
          break;
      }
    },
  ...
  computed: {
    ...
    broaderView: function broaderView() {
      ...
      var views = keys_default()(this.viewProps.views);
...
var header_component = normalizeComponent(
  ...
  headervue_type_template_id_eee908fc_lang_pug_render,
  headervue_type_template_id_eee908fc_lang_pug_staticRenderFns,
  false,
  null,
  null,
  null
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"0244c826-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/pug-plain-loader!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/vue-cal/cell.vue?vue&type=template&id=219f03ae&lang=pug&
var cellvue_type_template_id_219f03ae_lang_pug_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('transition-group',{staticClass:"vuecal__cell",class:( _obj = { splitted: _vm.splits.length, 'vuecal__cell--has-events': _vm.events.length }, _obj[_vm.cssClass] = true, _obj ),style:(_vm.cellStyles),attrs:{"tag":"div","name":("slide-fade--" + _vm.transitionDirection),"appear":_vm.transitions}},[_vm._l(((_vm.splits.length || 1)),function(i){return _c('div',{key:_vm.transitions ? (_vm.view + "-" + _vm.content + "-" + i) : i,staticClass:"vuecal__flex vuecal__cell-content",class:_vm.splits.length && ("vuecal__cell-split " + (_vm.splits[i - 1].class)),attrs:{"column":""}},[(_vm.splits.length)?_c('div',{staticClass:"split-label",domProps:{"innerHTML":_vm._s(_vm.splits[i - 1].label)}}):_vm._e(),(_vm.content)?_c('div',{staticClass:"vuecal__cell-date",domProps:{"innerHTML":_vm._s(_vm.content)}}):_vm._e(),(!_vm.events.length && ['week', 'day'].indexOf(_vm.view) > -1)?_c('div',{staticClass:"vuecal__no-event"},[_vm._t("no-event",[_vm._v(_vm._s(_vm.texts.noEvent))])],2):_vm._e(),(_vm.events.length && (['week', 'day'].indexOf(_vm.view) > -1 || (_vm.view === 'month' && _vm.eventsOnMonthView)) && _vm.checkCellOverlappingEvents(_vm.splits.length ? _vm.splitEvents[i] : _vm.events))?_c('div',{staticClass:"vuecal__cell-events"},_vm._l(((_vm.splits.length ? _vm.splitEvents[i] : _vm.events)),function(event,j){return _c('event',{key:j,attrs:{"vuecal":_vm.$parent,"event":event,"all-day-events":_vm.allDayEvents,"cell-events":_vm.splits.length ? _vm.splitEvents[i] : _vm.events,"split":_vm.splits.length ? i : 0},scopedSlots:_vm._u([{key:"event-renderer",fn:function(ref){
var event = ref.event;
var view = ref.view;
return _c('div',{},[_vm._t("event-renderer",null,{"view":view,"event":event})],2)}}],null,true)})}),1):_vm._e(),(_vm.view === 'month' && !_vm.eventsOnMonthView && _vm.events.length && !_vm.allDayEvents)?_vm._t("events-count-month-view",null,{"events":_vm.events}):_vm._e()],2)}),(_vm.timelineVisible)?_c('div',{key:_vm.transitions ? (_vm.view + "-now-line") : 'now-line',staticClass:"vuecal__now-line",style:(("top: " + _vm.todaysTimePosition + "px"))}):_vm._e()],2)
var _obj;}
var cellvue_type_template_id_219f03ae_lang_pug_staticRenderFns = []


// CONCATENATED MODULE: ./src/components/vue-cal/cell.vue?vue&type=template&id=219f03ae&lang=pug&

// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"0244c826-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/pug-plain-loader!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/vue-cal/event.vue?vue&type=template&id=c517dbb8&lang=pug&
var eventvue_type_template_id_c517dbb8_lang_pug_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"vuecal__event",class:_vm.eventClasses(_vm.event),style:(_vm.eventStyles(_vm.event)),on:{"mouseenter":function($event){return _vm.onMouseEnter($event, _vm.event)},"mouseleave":function($event){return _vm.onMouseLeave($event, _vm.event)},"contextmenu":function($event){return _vm.onContextMenu($event, _vm.event)},"touchstart":function($event){return _vm.onTouchStart($event, _vm.event)},"mousedown":function($event){return _vm.onMouseDown($event, _vm.event)},"click":function($event){return _vm.onClick($event, _vm.event)},"dblclick":function($event){return _vm.onDblClick($event, _vm.event)}}},[(_vm.vuecal.editableEvents)?_c('div',{staticClass:"vuecal__event-delete",on:{"mousedown":function($event){$event.stopPropagation();$event.preventDefault();return _vm.deleteEvent(_vm.event)},"touchstart":function($event){$event.stopPropagation();$event.preventDefault();return _vm.touchDeleteEvent(_vm.event)}}},[_vm._v(_vm._s(_vm.vuecal.texts.deleteEvent))]):_vm._e(),_vm._t("event-renderer",null,{"event":_vm.event,"view":_vm.vuecal.view.id}),(_vm.resizable)?_c('div',{staticClass:"vuecal__event-resize-handle",on:{"mousedown":function($event){_vm.vuecal.editableEvents && _vm.vuecal.time && _vm.onDragHandleMouseDown($event, _vm.event)},"touchstart":function($event){_vm.vuecal.editableEvents && _vm.vuecal.time && _vm.onDragHandleMouseDown($event, _vm.event)}}}):_vm._e()],2)}
var eventvue_type_template_id_c517dbb8_lang_pug_staticRenderFns = []


// CONCATENATED MODULE: ./src/components/vue-cal/event.vue?vue&type=template&id=c517dbb8&lang=pug&
...
/* harmony default export */ var eventvue_type_script_lang_js_ = ({
  ...
  methods: {
    eventStyles: function eventStyles(event) {
      ...
      return {
        ...
        height: "".concat(resizeAnEvent.newHeight && resizeAnEvent.eid === event.eid ? resizeAnEvent.newHeight : event.height, "px")
      };
    },
    eventClasses: function eventClasses(event) {
      ...
      var forceLeft = false;
      var deletable = clickHoldAnEvent.eid && (clickHoldAnEvent.eid === event.eid || event.linked.find(function (e) {
        return e.eid === clickHoldAnEvent.eid;
      }));

      if (simultaneous >= 3) {
        var split3 = simultaneous - 1;

        keys_default()(event.simultaneous).forEach(function (eid) {
          if (split3 && keys_default()(_this.cellEvents.find(function (e) {
            return e.eid === eid;
        ...
        var otherEvent = this.cellEvents.find(function (e) {
          return e.eid === keys_default()(event.simultaneous)[0];
        });
      ...
      return _ref = {}, _defineProperty(_ref, event.classes.join(' '), true), _defineProperty(_ref, 'vuecal__event--focus', focusAnEvent.eid === event.eid), _defineProperty(_ref, 'vuecal__event--background', event.background), _defineProperty(_ref, 'vuecal__event--deletable', deletable), _defineProperty(_ref, 'vuecal__event--overlapped', overlapped), _defineProperty(_ref, 'vuecal__event--overlapping', overlapping), _defineProperty(_ref, 'vuecal__event--split2', simultaneous === 2), _defineProperty(_ref, 'vuecal__event--split3', simultaneous >= 3), _defineProperty(_ref, 'vuecal__event--split-middle', overlapped && overlapping && simultaneous >= 3), _defineProperty(_ref, 'vuecal__event--split-left', forceLeft), _defineProperty(_ref, 'vuecal__event--all-day', event.allDay), _defineProperty(_ref, 'vuecal__event--multiple-days', keys_default()(event.multipleDays).length), _defineProperty(_ref, 'event-start', keys_default()(event.multipleDays).length && event.multipleDays.start), _defineProperty(_ref, 'event-middle', keys_default()(event.multipleDays).length && event.multipleDays.middle), _defineProperty(_ref, 'event-end', keys_default()(event.multipleDays).length && event.multipleDays.end), _ref;
    },
    // On an event.
  ...
  computed: {
    resizable: function resizable() {
      return this.vuecal.editableEvents && this.vuecal.time && this.event.startTime && !this.allDayEvents && !this.event.multipleDays.start && !this.event.multipleDays.middle && this.vuecal.view.id !== 'month';
    },
    domEvents: {
      get: function get() {
...
var event_component = normalizeComponent(
  ...
  eventvue_type_template_id_c517dbb8_lang_pug_render,
  eventvue_type_template_id_c517dbb8_lang_pug_staticRenderFns,
  false,
  null,
  null,
  null
...
/* harmony default export */ var cellvue_type_script_lang_js_ = ({
  ...
  methods: {
    checkCellOverlappingEvents: event_utils_checkCellOverlappingEvents
  },
  computed: {
    ...
    showAllDayEvents: function showAllDayEvents() {
    ...
    events: {
      get: function get() {
        ...
        var events = this.$parent.mutableEvents[this.formattedDate] || [];
        events.forEach(function (event) {
          if (_this.$parent.time && event.startTime && !(_this.showAllDayEvents && _this.allDayEvents)) {
            updateEventPosition(event, _this.$parent);
          }
        });
        return this.showAllDayEvents && this.view !== 'month' ? events.filter(function (e) {
          return !!e.allDay === _this.allDayEvents;
        }) : events;
      },
...
var cell_component = normalizeComponent(
  ...
  cellvue_type_template_id_219f03ae_lang_pug_render,
  cellvue_type_template_id_219f03ae_lang_pug_staticRenderFns,
  false,
  null,
  null,
  null
  ...
  methods: {
      ...
      switch (view) {
        ...
        case 'month':
          ...
          while (dateTmp.getTime() <= endTime) {
            ...
            formattedDate = formatDate(dateTmp, 'yyyy-mm-dd', this.texts); // If the first day of the month is not a FirstDayOfWeek (Monday or Sunday), prepend missing days to the days array.
            ...
            this.view.lastCellDate = startDate.addDays(41); // Save the events of each day of month + out of scope ones into view object.
    ...
    onMouseUp: function onMouseUp(e) {
      var _this$domEvents = this.domEvents,
          ...
          clickHoldAnEvent = _this$domEvents.clickHoldAnEvent; // On event resize end, emit event if duration has changed.
      ...
      if (resizeAnEvent.eid && resizeAnEvent.newHeight !== resizeAnEvent.originalHeight) {
        var event = this.mutableEvents[resizeAnEvent.startDate].find(function (item) {
          return item.eid === resizeAnEvent.eid;
        });
    ...
    onEventTitleBlur: function onEventTitleBlur(e, event) {
      ...
      if (event.linked.daysCount) {
        event.linked.forEach(function (e) {
          var dayToModify = _this4.mutableEvents[e.date];
    ...
    updateMutableEvents: function updateMutableEvents() {
      ...
      this.events.map(function (event) {
        ...
        var eid = "".concat(_this5._uid, "_").concat(_this5.eventIdIncrement++);
        event = assign_default()({
          eid: eid,
          startDate: startDate,
          startTime: startTime,
        ...
        if (!(event.startDate in _this5.mutableEvents)) _this5.$set(_this5.mutableEvents, event.startDate, []); // eslint-disable-next-line

        _this5.mutableEvents[event.startDate].push(event);
        ...
        if (multipleDays) {
          (function () {
            ...
            var startDateFormatted = formatDate(startDate, 'yyyy-mm-dd', _this5.texts); // Update First day event.
            ...
            for (var i = 1; i <= datesDiff; i++) {
              var date = formatDate(new Date(startDate).addDays(i), 'yyyy-mm-dd', _this5.texts);
              eventPieces.push({
                eid: "".concat(_this5._uid, "_").concat(_this5.eventIdIncrement++),
                date: date
              });
            }
            ...
            var _loop = function _loop(_i2) {
              ...
              var linked = [{
                ...
                return e.eid !== eventPieces[_i2 - 1].eid;
              }))); // Make array reactive for future events creations & deletions.

              if (!(date in _this5.mutableEvents)) _this5.$set(_this5.mutableEvents, date, []);

              _this5.mutableEvents[date].push(_objectSpread({}, event, {
                eid: eventPieces[_i2 - 1].eid,
                overlapped: {},
                overlapping: {},
                simultaneous: {},
                linked: linked,
    ...
    updateSelectedDate: function updateSelectedDate(date) {
      if (date && typeof date === 'string') {
        var _date$match = date.match(/(\d{4})-(\d{2})-(\d{2})(?: (\d{2}):(\d{2}))?/),
            _date$match2 = _slicedToArray(_date$match, 6),
            y = _date$match2[1],
            m = _date$match2[2],
            d = _date$match2[3],
            _date$match2$ = _date$match2[4],
            h = _date$match2$ === void 0 ? 0 : _date$match2$,
            _date$match2$2 = _date$match2[5],
            min = _date$match2$2 === void 0 ? 0 : _date$match2$2;

        date = new Date(y, parse_int_default()(m) - 1, d, h, min);
      }
    ...
    viewCells: function viewCells() {
      ...
      switch (this.view.id) {
        ...
        case 'month':
          ...
          todayFound = false;
          var startDate = new Date(this.view.firstCellDate); // Create 42 cells (6 rows x 7 days) and populate them with days.

          cells = Array.apply(null, Array(42)).map(function (cell, i) {
            var cellDate = startDate.addDays(i); // To increase performance skip checking isToday if today already found.
