        ...
        <div class="row">
            <div class="col-md-12 mt-3">
                <div class="card card-widget widget-user">
                    ...
                    <div class="widget-user-header text-white" style="background-image:url('./img/sport-background.jpg')">
                            ...
                            <div class="tab-pane active show" id="settings">
                                <form class="form-horizontal">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <input type="file" @change="updateProfile" name="picture" class="form-input">
                                        </div>
        ...
        methods : {
            getProfilePicture(){
                if(this.form.picture !== null && this.form.picture !== undefined) {
                    let picture = (this.form.picture.length > 200) ? this.form.picture : "img/profile/" + this.form.picture;
                    return picture;
                }
            },
            updateInfo(){
